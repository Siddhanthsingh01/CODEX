...
public class python_two extends AppCompatActivity {
    ...
    // url of our PDF file.
    String pdfurl = "https://firebasestorage.googleapis.com/v0/b/codex-4a5c4.appspot.com/o/python%2Fmultiply%20two%20matrices.pdf?alt=media&token=d662cad5-f211-4dbc-a433-d87ea7acbb6c";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_two);

        // pdf view.
        pdfView = findViewById(R.id.idPDFView);
        new python_two.RetrivePDFfromUrl().execute(pdfurl);
        ...
        mAddPersonFab.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(python_two.this, compiler.class);
