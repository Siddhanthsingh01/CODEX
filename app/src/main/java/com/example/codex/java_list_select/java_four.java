...
public class java_four extends AppCompatActivity {
    ...
    // url of our PDF file.
    String pdfurl = "https://firebasestorage.googleapis.com/v0/b/codex-4a5c4.appspot.com/o/java%2Fpalindrome%20prgm.pdf?alt=media&token=e27cbdf0-1e60-4f5d-a0ed-5bb1abf24d03";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new java_four.RetrivePDFfromUrl().execute(pdfurl);
        ...
        mAddPersonFab.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(java_four.this, compiler.class);
